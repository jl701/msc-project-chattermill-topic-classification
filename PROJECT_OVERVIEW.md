...
7. Treat the local-to-Gemini cascade as complete fixed-split selective-deployment evidence; its Pro variant beats pure Pro through fallback recovery and lower false-negative count, not because local is globally stronger. Prioritise Gemini-generated candidate descriptions and Gemini-assisted qualitative error taxonomy as separate dissertation-value experiments.
