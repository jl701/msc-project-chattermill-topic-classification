...
| Qwen LoRA | Full LOAO launch plan | Complete planning note | See `docs/qwen_lora_loao_launch_plan.md` | `docs/qwen_lora_loao_launch_plan.md`, `docs/thesis_completion_roadmap.md`, `report_notes.md` | Not an experiment result. Records optional fixed-split commands, full 12-fold LOAO fold IDs, validation/test order, output patterns, adapter recovery, prediction recovery, resource assumptions, and launch gates. Full Qwen LoRA LOAO remains unrun. |
