...
- The next user-confirmed Qwen hybrid priorities are: 1. asymmetric score-distance routing; 2. F1/call-rate Pareto curve; 3. lightweight defer router, lower priority; 4. fair per-aspect routing, lower priority; 5. candidate-wise Qwen semantic judge, later; 6. aspect descriptions/boundary examples, later.
